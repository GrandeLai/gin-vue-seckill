...
import (
	"gin-vue-seckill/jdaw_product_srv/controller"
	_ "gin-vue-seckill/jdaw_product_srv/data_source"
...
func main() {
	...
	// Register handler
	_ = product.RegisterProductsHandler(srv.Server(), new(controller.Products))
	_ = seckill.RegisterSeckillsHandler(srv.Server(), new(controller.Seckills))
